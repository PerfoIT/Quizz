...
- `ADMIN_PASSWORD`: mot de passe de la page d'administration, par defaut `perfo-admin`
...
1. L'animateur ouvre `/host`, choisit un quiz et cree une session.
...
Elle permet de creer une banque de questions, puis de creer un quiz en selectionnant les questions de cette banque. Types prevus:
